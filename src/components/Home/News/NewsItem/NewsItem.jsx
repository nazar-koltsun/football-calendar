...
function NewsItem(props) {
    return (
        <article className={classes.NewsItem}>
            ...
            <img className={classes.NewsItemImg} src='https://image-service.onefootball.com/crop/face?h=128&image=https%3A%2F%2Ficdn.football-espana.net%2Fwp-content%2Fuploads%2F2020%2F12%2FNeymar-1.jpg&q=85&w=128&fit=crop' loading='lazy' alt=""/>
        </article>
    );
}
